...
type
  ...
  private
    ...
    procedure CreateConnector(aFrom, aTo: TdcLocation; aIsButton: Boolean =
        True);
    ...
    procedure DrawObjMouseDown(Sender: TObject; Button: TMouseButton; Shift:
        TShiftState; X, Y: Integer);
    procedure DrawObjMouseMove(Sender: TObject; Shift: TShiftState; X, Y:
        Integer);
    procedure DrawObjMouseUp(Sender: TObject; Button: TMouseButton; Shift:
        TShiftState; X, Y: Integer);
...
procedure TQuestEditorForm.CountFocusedDrawObjs(out cnt: integer; out last:
    TDrawObject);
var
  i: integer;
begin
...
procedure TQuestEditorForm.CreateConnector(aFrom, aTo: TdcLocation; aIsButton:
    Boolean = True);
var
...
procedure TQuestEditorForm.DrawObjMouseDown(Sender: TObject; Button:
