...
begin
  ...
  //Image := GV_Image_Load(RezFile, GV_ColorKey, 'media/images/gamevision.jpg', 256, 256);
  Image := GV_Image_Load(RezFile, GV_ColorKey, 'media/images/gamevision.bmp', 256, 256);
...
//procedure GV_Audio_Update; external 'gamevision.dll';
...
begin
  ...
  repeat
    ...
    begin
      ...
      GV_Font_PrintY(Font, 0, py, 12, GV_Green,  'Random Muz  - M', []);
      GV_Font_PrintY(Font, 0, py, 12, GV_Green,  'Muz Vol     - Home/End ', []);
      GV_Font_PrintY(Font, 0, py, 12, GV_Green,  'Sfx vol     - PgUp/PgDn', []);
      GV_Font_PrintY(Font, 0, py, 24, GV_Green,  'Exit        - Esc', []);

      GV_Font_PrintY(Font, 0, py, 12, GV_Yellow, 'Muz Vol     - %1.1f', [MusicVol]);
