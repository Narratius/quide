...
const
  SCREEN_CAPTION = 'Sprite'; //@@ screen caption
...
begin
  repeat
    ...
    begin
      ...
      GV_Sprite_RenderImage(BossSprite.Handle, 0, BossSprite.Group, 320-128, 240, 1.0, 0.0, GV_White, nil, GV_RenderState_Blend);
      GV_Sprite_RenderImage(BossSprite.Handle, 1, BossSprite.Group, 320, 240, 1.0, 0.0, GV_White, nil, GV_RenderState_Blend);
      GV_Sprite_RenderImage(BossSprite.Handle, 2, BossSprite.Group, 320+128, 240, 1.0, 0.0, GV_White, nil, GV_RenderState_Blend);

      GV_Font_Print(Font[0], 320-154, 310, GV_Yellow, 'frame 0', []);
      GV_Font_Print(Font[0], 320-026, 310, GV_Yellow, 'frame 1', []);
      GV_Font_Print(Font[0], 320+102, 310, GV_Yellow, 'frame 2', []);
