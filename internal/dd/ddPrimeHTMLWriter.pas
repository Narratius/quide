...
uses
 ...
 L3Base, l3Types, k2Types, ddParagraphProperty, ddDocumentAtom, ddTable,
 ddTableRow;
...
uses StrUtils, SysUtils, evdStyles, RTFTypes, k2Base, k2Tags, AnnoTopic_Const,
 DocUment_Const, Math, ddTableCell, ddTextParagraph;
...
procedure TddPrimeHTMLWriter.WriteTable(const Table: TddTable);
var
 i, j: Integer;
 l_Row: TddTableRow;
 l_EtalonRowIndex,
...
procedure TddPrimeHTMLWriter.WriteTableRow(const Row: TddTableRow; const aIsSBS: Boolean = False;
