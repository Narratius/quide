...
{ $Id: ddDoc2Rtf.pas,v 1.4 2013/04/11 16:46:27 lulin Exp $ }
...
{$I drs.pas Include the constant and type declarations}

const
 cWrsDllName = 'WRS4.DLL';
...
begin
 ...
 WrsSetLicenseKey('T6370-95L40-ME289');
end;
...
begin
 ...
 DrsSetLicenseInfo('U6380-92WB0-GL851', 'smo120822-1', 'Garant');
end;
