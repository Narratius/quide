...
{ $Id: ddDocReader.pas,v 1.43 2012/11/09 08:52:29 narry Exp $ }
...
begin
 ...
 Filer.Open;
 try
  Assert(Supports(Filer, IStream, l_IStream), 'TddCustomDocReader.Execute: Filer не поддерживает IStream!');
