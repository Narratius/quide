...
uses
 ...
 ddAppConfigDataAdapters, ddAppConfigTypes, ddConfigStorages, ddAppConfigConst, ddAppConfigUtils;
...
constructor TddListConfigItem.Create(const aAlias, aCaption: AnsiString; aDefaultValue: TddConfigValue; aMasterItem:
...
function TddListConfigItem.GetBooleanValue: Boolean;
begin
  if Control <> nil then
...
procedure TddListConfigItem.pm_SetLabelTop(const aValue: Boolean);
begin
...
procedure TddListConfigItem.SetChanged(Value: Boolean);
begin
 inherited;
 if DataAdapter <> nil then
