...
// $Id: ddRTFKeywords.pas,v 1.79 2013/04/11 16:46:28 lulin Exp $ 
...
begin
 ...
 begin
  ...
  AddKeyword2('absh', kwdValu, valu_absh, propNone, 0, 0);
  AddKeyword2('abslock', kwdFlag, flag_abslock, propNone, 0, 0);
  AddKeyword2('absw', kwdValu, valu_absw, propNone, 0, 0);
...
begin
 ...
 begin
  ...
  AddKeyword2('bin', kwdValu, valu_bin, propNone, 0, 0);
  ...
  AddKeyword2('bxe', kwdFlag, flag_bxe, propNone, 0, 0);
   ...
   AddKeyword2('emfblip', kwdFlag, flag_emfblip, propNone, 0, 0);
   ...
   AddKeyword2('jpegblip', kwdFlag, flag_jpegblip, propNone, 0, 0);
   ...
   AddKeyword2('pngblip', kwdFlag, flag_pngblip, propNone, 0, 0);
   ...
   AddKeyword2('posx', kwdValu, valu_posx, propNone, 0, 0);
   ...
   AddKeyword2('posy', kwdValu, valu_posy, propNone, 0, 0);
   ...
   AddKeyword2('sectd', kwdFlag, flag_sectd, propNone, 0, 0);
   ...
   AddKeyword2('shpbottom', kwdValu, valu_shpbottom, propNone, 0, 0);
   ...
   AddKeyword2('shpleft', kwdValu, valu_shpleft, propNone, 0, 0);
   AddKeyword2('shplid', kwdValu, valu_shplid, propNone, 0, 0);
   AddKeyword2('shplockanchor', kwdFlag, flag_shplockanchor, propNone, 0, 0);


   AddKeyword2('shpright', kwdValu, valu_shpright, propNone, 0, 0);
   AddKeyword2('shptop', kwdValu, valu_shptop, propNone, 0, 0);
   ...
   AddKeyword2('uc', kwdValu, valu_uc, propNone, 0, 0);
   ...
   AddKeyword2('wmetafile', kwdValu, valu_wmetafile, propNone, 0, 0);
...
begin
 ...
 begin
   ...
   AddDestination('pntext',  dest_pntext, ord(rdsNorm));
   ...
   AddDestination('shp',  dest_shp, ord(rdsNorm));
   AddDestination('shpgrp',  dest_shpgrp, ord(rdsNorm));
   AddDestination('shpinst',  dest_shpinst, ord(rdsShpInst));
   AddDestination('shppict',  dest_shppict, ord(rdsNorm));
   AddDestination('shprslt',  dest_shprslt, ord(rdsShpRslt)); // Было Norm
   AddDestination('shptxt',  dest_shptxt, ord(rdsShpTxt){IfThen(Lite, Ord(rdsShpTxt), ord(rdsNorm))});  // Почему отличия?

   AddDestination('sp',  dest_sp, ord(rdsSkip));
...
//   AddDestination('ud',  dest_ud, ord(rdsSkip));
  ...
  AddDEstination('mmathPict', dest_mmathPict, Ord(rdsNorm));
 end;
end;
...
{
   AddKeyword2('keep', kwdFlag, flag_keep, propPAP, ipropKeep, 0);
   AddKeyword2('keepn', kwdFlag, flag_keepn, propPAP, ipropKeep, 0);
}
   ...
   //AddKeyword2('tb', kwdValu, valu_tb, propPAP, ipropTabBar, UseParam);
   ...
   AddKeyword2('clvertalt', kwdFlag, flag_clvertalt, propCell, ipropJust, ord(cellTop));
{
   ...
   AddSymbol('nestcell', symb_nestcell, propCell, 0, 0);
 end;
end;
