...
{ $Id: dd_lcDossierDecorator.pas,v 1.13 2013/04/11 16:46:29 lulin Exp $ }
 ...
 begin
  ...
  begin
   ...
   begin
    ...
    if not AnsiStartsText('Высшего', l_Source) or (AnsiStartsText('Высшего', l_Source) and AnsiStartsText('ВАС-', l_Code)) then
    begin
