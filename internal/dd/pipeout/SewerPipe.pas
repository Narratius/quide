...
{ $Id: SewerPipe.pas,v 1.157 2013/04/19 13:10:48 lulin Exp $ }
...
begin
 ...
 f_EmptyTableElim.Generator:= {f_PicFilter;
...
begin
 ...
 { TODO : Нужно преобразовать Single в NumList }
...
begin
 ...
 //if f_FilerType <> 1 then // пропускаем справки
  TopicInit
end;
