...
{$IFDEF UseProjectDefine}
 {$I ProjectDefine.inc}
{$ENDIF}
{ $Id: dd_lcXMLReader2.pas,v 1.11 2013/04/25 10:18:09 fireton Exp $ }
...
begin
 ...
 try
  ...
  try
   Generator.AddPCharLenAtom(k2_tiName, aStr.AsWStr);
  finally
   Generator.Finish;
  end;
 finally
  ...
  try
   ...
   begin
    ...
    try
     ...
     Generator.AddPCharLenAtom(k2_tiNumber, f_LawCaseNum.AsWStr);
    finally
     Generator.Finish;
    end;
   end;
   ...
   begin
    ...
    try
     ...
     if not l3IsNil(f_DocNum) then
      Generator.AddPCharLenAtom(k2_tiNumber, f_DocNum.AsWStr);
    finally
     Generator.Finish;
    end;
   end;
...
begin
 ...
 if l3Same(aStr, 'Participant') then
  Generator.StartChild(k2_idParticipant);
end;
  ...
  try
   ...
   begin
    ...
    try
     ...
     Generator.AddPCharLenAtom(k2_tiName, l_Participant.Name.AsWStr);
