...
uses
 Classes, Controls,
 ddAppConfigTypes, ddConfigStorages, StdCtrls, ddAppConfigConst;
...
type
  ...
  protected
    ...
    function GetStringValue: AnsiString; override;
...
constructor TddStringConfigItem.Create(const aAlias, aCaption: AnsiString; aDefaultValue: TddConfigValue; aMasterItem:
...
begin
  ...
  TEdit(Result).PasswordChar:= PasswordChar;
...
function TddBrowseConfigItem.GetStringValue: AnsiString;
begin
...
procedure TddBrowseConfigItem.SetEnabled(Value: Boolean);
begin
...
constructor TddTextConfigItem.Create(const aAlias, aCaption: AnsiString; aDefaultValue: TddConfigValue; aMasterItem:
    TddBaseConfigItem = nil);
begin
  inherited Create(aAlias, aCaption, aDefaultValue, aMasterItem);
  f_Value.Kind:= dd_vkString;
