...
//$Id: ddHTMLWriter.pas,v 1.92 2013/04/11 16:46:27 lulin Exp $
...
Uses
 ...
 ddTable, ddTableRow, ddDocumentAtom, ddTextSegment;
       ...
       if aStyle.StyleDef = sdParagraph then
        ...
        begin
         AddStyleProperty(l_List, 'margin:', '0 in;', '');
          if (xaLeft <> propUndefined){ and (xaLeft <> 0)} then
           AddStyleProperty(l_List, 'margin-left:', InchStr(xaLeft{+1440}), '');
          if (xaRight <> propUndefined) and (xaRight <> 0) then
