...
{ $Id: dd_lcTextFormatter2.pas,v 1.33 2013/04/12 15:02:04 lulin Exp $ }
...
type
 ...
 private
  ...
  function _ExtractNumber(const aPara: Ik2Tag; var NeedCheckDate: Boolean): AnsiString;
 protected
  ...
  function CheckExtractNumber(const aPara: Ik2Tag; out theNumber: AnsiString; out
      theStartPos, theLength: Integer; out theIsCaseCode: Boolean): Boolean;
  procedure CheckLostParameters; virtual;
  function CheckStartText(const aPara: Ik2Tag): Boolean;
  ...
  function EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction; virtual;
  function IsBodyStart(const aPara: Ik2Tag; out IsResolution: Boolean): Boolean;
  function IsCityName(const aPara: Ik2Tag; var aCityName: ShortString): Boolean;
  function isCourtName(const aPara: Ik2Tag): Boolean;
  function CheckExtractDate(const aPara: Ik2Tag; out theDate: AnsiString; out theStartPos,
      theLength: Integer): Boolean;
  function CheckStartsDate(const aPara: Ik2Tag): Boolean;
  function CheckDateStart(const aPara: Ik2Tag; aPos: Integer = 0): Integer;
  function CheckDateEnd(const aPara: Ik2Tag; aPos: Integer = 0): Integer;
  function FindDatePos(const aPara: Ik2Tag; out theDatePos: Tl3MatchPosition; aPos:
      Integer = 0): Boolean;
  function IsDate(const aPara: Ik2Tag): Boolean;
  function IsNumber(const aPara: Ik2Tag): Boolean;
  function IsPrezidium: Boolean;
  function NormalizeText(const aLeaf: Ik2Tag): AnsiString; overload;
...
function Tdd_lcBaseFormatter.EnableWrite(const aPara: Ik2Tag): Tdd_lcTextReaction;
begin
 Result:= lcWrite;
end;
...
procedure Tdd_lcBaseFormatter.DoStartChild(TypeID: Long);
begin
 inherited;
 if CurrentType.InheritsFrom(k2_idDocument) then
  ClearParameters
...
procedure Tdd_lcBaseFormatter.DoWritePara(const aLeaf: Ik2Tag);
var
...
function Tdd_lcBaseFormatter.CheckExtractDate(const aPara: Ik2Tag; out theDate:
...
function Tdd_lcBaseFormatter.CheckStartsDate(const aPara: Ik2Tag): Boolean;
begin
 Result:= CheckDateStart(aPara) = 0;
end;

function Tdd_lcBaseFormatter.CheckStartText(const aPara: Ik2Tag): Boolean;
var
 i: Integer;
 l_Pos: Tl3MatchPosition;
const
...
function Tdd_lcBaseFormatter._ExtractNumber(const aPara: Ik2Tag; var NeedCheckDate:
    Boolean): AnsiString;
...
function Tdd_lcBaseFormatter.IsBodyStart(const aPara: Ik2Tag; out IsResolution:
    Boolean): Boolean;
begin
...
function Tdd_lcBaseFormatter.IsCityName(const aPara: Ik2Tag; var aCityName:
    ShortString): Boolean;
var
 l_Pos: Tl3MatchPosition;
begin
...
function Tdd_lcBaseFormatter.isCourtName(const aPara: Ik2Tag): Boolean;
var
 l_S,
...
function Tdd_lcBaseFormatter.IsNumber(const aPara: Ik2Tag): Boolean;
var
 l_Pos: Tl3MatchPosition;
 l_Number: AnsiString;
...
function Tdd_lcBaseFormatter.CheckExtractNumber(const aPara: Ik2Tag; out theNumber:
...
function Tdd_lcBaseFormatter.CheckDateStart(const aPara: Ik2Tag; aPos: Integer = 0):
    Integer;
var
 l_pos: Tl3MatchPosition;
begin
...
function Tdd_lcBaseFormatter.CheckDateEnd(const aPara: Ik2Tag; aPos: Integer = 0):
    Integer;
var
 l_pos: Tl3MatchPosition;
begin
...
function Tdd_lcBaseFormatter.FindDatePos(const aPara: Ik2Tag; out theDatePos:
...
function Tdd_lcBaseFormatter.IsDate(const aPara: Ik2Tag): Boolean;
var
 l_Date: AnsiString;
...
function Tdd_lcBaseFormatter.NormalizeText(const aLeaf: Ik2Tag): AnsiString;
begin
...
function Tdd_lcDefaultChildFormatter.EnableWrite(const aPara: Ik2Tag):
    Tdd_lcTextReaction;
begin
 Result:= lcWrite;
end;
