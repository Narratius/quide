...
uses
  ddBase, ddDocumentAtom, ddTextParagraph, k2Prim, l3ProtoPersistentRefList;
...
constructor TddParaList.Create(aOwner: TObject);
begin
  inherited;
...
procedure TddParaList.Write2Generator(const Generator: Ik2TagGenerator; const
...
begin
  ...
  begin
    ...
    l_A.Write2Generator(Generator, LiteVersion);
  end;
end;
